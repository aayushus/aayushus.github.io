...
const AGENT_BADGES = {
  ...
  guardian: `<span class="agent-badge guardian-badge" title="Guardian"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" class="badge-bg"/><path d="M12 21.5 C12 21.5, 19 18, 19 12 L19 5.5 L12 2.5 L5 5.5 L5 12 C5 18, 12 21.5, 12 21.5 Z" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none" class="badge-icon"/><rect x="10" y="11" width="4" height="3" rx="1" stroke-width="1.5" fill="none" class="badge-icon"/><path d="M11 11 L11 9 A1 1 0 0 1 13 9 L13 11" stroke-width="1.5" fill="none" class="badge-icon"/></svg></span>`,
  mender: `<span class="agent-badge mender-badge" title="Mender"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" class="badge-bg"/><rect x="3" y="7" width="18" height="13" rx="2.5" stroke-width="1.8" fill="none" class="badge-icon"/><path d="M9 7 V5.5 A1.5 1.5 0 0 1 10.5 4 L13.5 4 A1.5 1.5 0 0 1 15 5.5 V7" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" class="badge-icon"/><path d="M12 10.5 V16.5 M9 13.5 H15" stroke-width="1.8" stroke-linecap="round" class="badge-icon"/></svg></span>`
};
